...
namespace ServiceRest_20180140110_NurAfandiMujib
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-9BLFC43\\AFANDISQL;Initial Catalog=TI UMY;Persist Security Info=True;User ID=sa; Password=Nurafandi09");
        ...
        {
            {
                ...
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-9BLFC43\\AFANDISQL;Initial Catalog=TI UMY;Persist Security Info=True;User ID=sa; Password=Nurafandi09");
